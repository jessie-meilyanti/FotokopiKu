            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-gray-900 hover:text-gray-900 dark:hover:text-white focus:outline-none transition ease-in-out duration-150">
                ...
                @else
                    <div class="flex items-center space-x-3">
                        ...
                        <x-button href="{{ route('register') }}" color="indigo">Daftar</x-button>
                    </div>
                @endauth
            </div>
